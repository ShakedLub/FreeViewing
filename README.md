...
This analysis arranges the eye tracking data, and than calculates the object analysis, region analysis and 
...
#CNN analysis
This analysis calculates the RSA analysis, comparing fixation maps in both visibility conditions to activations of a CNN.
The analysis code is in:
...
A.Run_AwarenessResultsExperiments.m - creates awareness results figure.
Possible conditions: saveFlag- 1 save, 0 do not save

B.Run_CNNResults.m - create cnn results figures.
Possible conditions: AnalysisType- 1 main analysis, 3 RttM check analysis
saveFlag- 1 save, 0 do not save

C.Run_EyeMovementResultsExperiments.m - create object analysis, region analysis and emotional face attribute analysis figures.
Possible conditions: AnalysisType- 1 main analysis, 2 low level type 1 analysis, 3 RttM check analysis
saveFlag- 1 save, 0 do not save

D. Run_ObjectClassificationPlots.m - creates object analysis figures.
Possible conditions: saveFlag- 1 save, 0 do not save

E.Run_RegionClassificationPlots.m - creates region analysis figures.
Possible conditions: saveFlag- 1 save, 0 do not save
...
#Behavioral analysis 
This analysis checks awareness of all participants, and calculates group level awareness.
The analysis code is in:
...
#breakxaxis
code for creating a break in x axis in a plot for better visualization.
...
FreeViewing\Exp3\Analysis\AnalysisFolders\ResultsStructs\RSA\Pilot1&2_RttMCheck- CNN analysis results, RttM check analysis, results experiment 1&2
...
FreeViewing\Exp3\Raw Data\EyeTracker\Extracted files\Pilot1 - mat file for each participant with eye tracking data, eta file for each participant used for the analyzer that parsed the data to fixations and saccades (experiment 1) 
...
2. Analysis code:
This code arranges the eye tracking data and creates fixation maps for each image, that are used to define 
high level regions (and High & low regions) in the region analysis.
The analysis code is in:
FreeViewing\Exp2\Analysis\Analysis Code\ResultsAnalysis\EyeTrackingAnalysis
- Run the code by running the script: Run.m in the command window
Chose whether to save the results by changing the saveFlag (1 save, 0 do not save).
...
FreeViewing\Exp2\Raw Data\EyeTracker\Extracted files\Pilot3 - mat file for each participant with eye tracking data, eta file for each participant used for the analyzer that parsed the data to fixations and saccades. 
