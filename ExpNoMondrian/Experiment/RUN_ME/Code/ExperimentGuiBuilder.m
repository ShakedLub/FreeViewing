classdef ExperimentGuiBuilder < handle
    ...
    properties (Access= private)            
        ...
        perform_post_exp_updates = [];
    end
               
    methods (Access= public)        
        function obj= ExperimentGuiBuilder(exp_name, background_color, run_exp_func, gui_xml_file_path, perform_post_exp_updates)                        
            if nargin==4
            ...
            obj.perform_post_exp_updates = perform_post_exp_updates;
            ...
            function runExpBtnCallback(~,~)
                ...
                if obj.perform_post_exp_updates
        ...
        function uicontrolRadios(obj, control_i, parameter_name, possible_values, possible_values_strs, sessions_nr_for_auto_toggle)             
            ...
            if ischar(value) && all(isstrprop(value,'digit'))
