...
cd ..\..\..\..\
if condition == 1
    Paths.FixationMapsPathNoMondrians=[pwd,'\ExpNoMondrian\Analysis\AnalysisFolders\ResultsImages\FixationMaps'];
elseif condition == 2
    Paths.FixationMapsPathNoMondrians=[pwd,'\ExpNoMondrian\Analysis\AnalysisFolders\ResultsImages\FixationMapsNoBlinks'];
end
cd(Paths.ImageAnalysisFolder)
