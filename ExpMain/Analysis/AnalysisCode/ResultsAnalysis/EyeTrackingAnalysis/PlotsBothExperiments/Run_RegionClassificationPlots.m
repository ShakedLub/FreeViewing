...
Paths.FixationMap1=[foldersPath,'\ResultsImages\FixationMapsRemoveCenterBias\Experiment1'];
Paths.FixationMap2=[foldersPath,'\ResultsImages\FixationMapsRemoveCenterBias\Experiment2'];
%result paths
