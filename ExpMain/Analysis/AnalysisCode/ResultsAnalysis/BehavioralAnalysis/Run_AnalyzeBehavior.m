...
Paths.ExpMatrixFolder=[Paths.DataFolder,'\Behavioral\Experiment',EXP_NUM];
...
if saveFlag
    save(['TrialsRemoved_Experiment',EXP_NUM,'Final.mat'],'TrialsRemoved')
    save(['Results_Awareness_Experiment',EXP_NUM,'Final.mat'],'Results_Awareness')
    save(['Summary_Awareness_Experiment',EXP_NUM,'Final.mat'],'Summary_Awareness')
    save(['Param_Experiment',EXP_NUM,'Final.mat'],'Param')
    save(['Specific_Trials_Exclude_Experiment',EXP_NUM,'Final.mat'],'Specific_Trials_Exclude')
end
...
plotPAS(dataPAS)
if saveFlag
    save(['dataPAS_Experiment',EXP_NUM,'Final.mat'],'dataPAS')
end

%create table for bayesian parameter estimation analysis(R)
createTableTrialLevelObjectiveData(EXPDATA_ALL_withoutAware,saveFlag,EXP_NUM)
%create table for GBC and GB-Bayes analysis (R)
createTableSubectLevelObjectiveData(Summary_Awareness_withoutAware,saveFlag,EXP_NUM)