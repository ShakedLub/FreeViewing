...
function h = rm_raincloud(data, dotSize, colours, plot_top_to_bottom, density_type, bandwidth)
...
for i = 1:n_plots_per_series
    for j = 1:n_series
        ...
        % scatter rainclouds
        h.s{i, j} = scatter(data{i, j}, -jit{i, j} + ks_offsets(i), 'MarkerFaceColor', colours(j, :), 'MarkerEdgeColor', 'none', 'MarkerFaceAlpha', 0.5, 'SizeData', dotSize{i,j});
